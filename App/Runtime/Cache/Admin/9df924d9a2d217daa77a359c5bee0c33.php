...
<frameset rows="76,*" framespacing="0" border="0">
  ...
  <frameset cols="180, 10, *" framespacing="0" border="0" id="frame-body">
    <frame src="<?php echo U('Index/left')?>" id="menu-frame" name="menu-frame" frameborder="no" scrolling="yes">
    <frame src="<?php echo U('Index/drag')?>" id="drag-frame" name="drag-frame" frameborder="no" scrolling="no">
    <frame src="<?php echo U('Index/main')?>" name="main-frame" frameborder="no" scrolling="yes">
  </frameset>
</frameset>
</head>
<body>
