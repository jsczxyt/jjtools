...
<div class="main-div">
  <form action="/index.php/Admin/Cate/add" method="post" name="theForm" enctype="multipart/form-data">
      ...
      <tr>
        ...
        <td>
          <select name="parent_id">
              ...
              <option value="<?php echo $v['id']?>"><?php echo str_repeat('--',$v['deep']); echo $v['cate_name'];?></option>
                        <?php }?>
                      </select>
        </td>
      </tr>
