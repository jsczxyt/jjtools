...
<span class="action-span1"><a href="#"> 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品类型 </span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <tr align="center" class="0" id="0_1" id = 'tr_1'>
    <td align="left" class="first-cell" style = 'padding-left="0"'>
      ...
      <span><a href="#" ></a><?php echo $v['type_name']?></span>
    </td>
    <td width="10%"><?php echo $v['num']?></td>
    <td width="24%" align="center"><a href="<?php echo U('Attr/lst',array('type_id'=>$v['id']))?>">属性列表</a> |<a href="<?php echo U('edit',array('id'=>$v['id']))?>">编辑</a>|
