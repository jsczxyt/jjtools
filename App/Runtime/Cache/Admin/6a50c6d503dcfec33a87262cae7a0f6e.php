        ...
        <ul>
            <li class="explode" key="02_cat_and_goods" name="menu">
                ...
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo U('Cate/lst')?>" target="main-frame">商品分类</a></li>
                    <li class="menu-item"><a href="<?php echo U('Cate/add')?>" target="main-frame">分类添加</a></li>
                    <li class="menu-item"><a href="<?php echo U('News/lst')?>" target="main-frame">新闻列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('News/add')?>" target="main-frame">新闻添加</a></li>
                </ul>
            </li>
