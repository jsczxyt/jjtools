...
<table cellpadding="3" cellspacing="1">
  ...
  <?php foreach($goodsdata as $v){?>
    ...
    <td align="center" width="100"><img height="100"  src="/Public/Uploads/<?php echo $v['goods_thumb']?>"></td>
    <td><span ><?php echo $v['goods_name']?></span></td>
    <td align="center"><span ><?php echo $v['cate_name']?></span></td>
    <td align="center"><span ><?php echo $v['goods_key']?></td>
    <td align="center"><img src="/Public/Admin/images/icon_edit.gif"  /></td>
