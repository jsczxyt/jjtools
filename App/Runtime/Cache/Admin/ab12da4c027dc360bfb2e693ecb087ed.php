...
<script type="text/javascript">
    $(function(){
        ...
        $("form").submit(function(e){
            $('input[name=news_key]').val($('input[name=news_key]').val().replace(/\，/g,","));
        })
    })
</script>
    <script type="text/javascript">
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div" >
      <form enctype="multipart/form-data" action="/index.php/Admin/Newsinfo/add" method="post" name="theForm" >
        <!-- 最大文件限制 -->
        <!-- 通用信息 -->
        <table width="90%" id="general-table">
          <tr>
            ...
            <tr>
                ...
                <td><textarea name="news_desc" id="" cols="60" rows="10"></textarea></td>
            </tr>
        </table>
          <hr/>
